package org.example.yogabusinessmanagementweb.common.config.payment;
...
public class VNPAYConfig {
    ...
    public Map<String, String> getVNPayCourseConfig(OrderCourseCreationRequest orderCourseCreationRequest) {
        Map<String, String> vnpParamsMap = new HashMap<>();
        vnpParamsMap.put("vnp_Version", this.vnp_Version);
        vnpParamsMap.put("vnp_Command", this.vnp_Command);
        vnpParamsMap.put("vnp_TmnCode", this.vnp_TmnCode);
        ...
        String vnp_ExpireDate = formatter.format(calendar.getTime());
        vnpParamsMap.put("vnp_ExpireDate", vnp_ExpireDate);
        vnpParamsMap.put("vnp_OrderInfo", "Order123|"+"|"+ "|"+ orderCourseCreationRequest.getCourseCartId());
